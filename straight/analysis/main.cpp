...
CONDITION cond = {16000.0, 5.0, 10.0, 1024, 24, 513, NULL, NULL, NULL, NULL,
		  XFALSE, XFALSE, XFALSE, XFALSE, XFALSE, XFALSE, XTRUE,
		  XFALSE, XFALSE, XTRUE, XFALSE};
...
OPTION option_struct[] = {
    ...
    {"-nflr", NULL, "adding noise floor", NULL, 
	 NULL, TYPE_BOOLEAN, &cond.nflr_flag, XFALSE},
...
int main(int argc, char *argv[])
{
    ...
    */
	...
	if (cond.msg_flag == XTRUE) fprintf(stderr, "straight body done\n");
    }
